export default {
  ...
  address: 'Address',
  admin: 'Admin',
  admin_count: 'Number of Adminstrator',
  ...
  content_description: 'Pickup Overview',
  ...
  main_image_thumbnail: 'Main Image Thumbnail',
